...
HD_PWD='C:/Xilinx/labs/merge_array/merge_array.runs/design_1_merge_array_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_merge_array_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_merge_array_0_0.tcl
