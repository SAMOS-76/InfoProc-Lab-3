...
#
# Generated by Vivado on Thu Jan 22 10:22:02 +0000 2026
...
# Script info
echo -e "cic_compiler_0.sh - Script generated by export_simulation (Vivado v2020.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_10 -L axi_utils_v2_0_6 -L cic_compiler_v4_0_15 -L xil_defaultlib -L secureip -L xpm --snapshot cic_compiler_0 xil_defaultlib.cic_compiler_0 -log elaborate.log
}
