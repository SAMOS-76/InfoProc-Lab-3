...
HD_PWD='C:/Xilinx/PYNQ/boards/Pynq-Z1/base/myproj/project_1.runs/base_ila_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_ila_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_ila_0_1.tcl
