...
HD_PWD='C:/Xilinx/PYNQ/boards/Pynq-Z1/base/myproj/project_1.runs/base_rst_ps7_0_100M_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_rst_ps7_0_100M_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_rst_ps7_0_100M_1_0.tcl
